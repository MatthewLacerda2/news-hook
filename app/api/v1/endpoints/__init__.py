...
from app.api.v1.endpoints import alert, auth, llm_models, user_document, event, alert_chats
...
router.include_router(alert_chats.router, prefix="/alert-chats", tags=["alert_chats"])