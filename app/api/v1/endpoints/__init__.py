...
from app.api.v1.endpoints import alert, auth, llm_models, user_document, event, alert_chat
...
router.include_router(alert_chat.router, prefix="/alert-chats", tags=["alert_chats"])