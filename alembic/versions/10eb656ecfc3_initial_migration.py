...
Revision ID: 10eb656ecfc3
Revises: 
Create Date: 2025-06-01 23:41:24.283355
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.String(length=36), nullable=False),
    sa.Column('source', sa.Enum('WEBHOOK', 'WEBSCRAPE', 'API', 'YOUTUBE', 'USER_DOCUMENT', 'MANUAL_DOCUMENT', name='datasource'), nullable=False),
